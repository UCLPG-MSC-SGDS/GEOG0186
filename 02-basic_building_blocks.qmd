...
## RStudio Interface (Length: 00:07:08)

```{r, warnings=FALSE, message=FALSE, echo=FALSE}
library(vembedr)
embed_youtube('p21WD6EYGHQ', height=400, allowfullscreen = TRUE) %>% use_align('center')
```
[[**Watch on YouTube**]](https://youtu.be/p21WD6EYGHQ)
...
## Using R Console as a Calculator (Length: 00:07:26)

```{r, warnings=FALSE, message=FALSE, echo=FALSE}
library(vembedr)
embed_youtube('dxymrkN1omg', height=400, allowfullscreen = TRUE) %>% use_align('center')
```
[[**Watch on YouTube**]](https://youtu.be/dxymrkN1omg)
...
## Creating basic objects and assignment operator (Length 00:12:59)

```{r, warnings=FALSE, message=FALSE, echo=FALSE}
library(vembedr)
embed_youtube('N7NKU-uCDJ8', height=400, allowfullscreen = TRUE) %>% use_align('center')
```
[[**Watch on YouTube**]](https://youtu.be/N7NKU-uCDJ8)
...
## How to identify data types (Length 00:08:29)

```{r, warnings=FALSE, message=FALSE, echo=FALSE}
library(vembedr)
embed_youtube('VKuhiS97C6k', height=400, allowfullscreen = TRUE) %>% use_align('center')
```
[[**Watch on YouTube**]](https://youtu.be/VKuhiS97C6k)
...
## How to enter data and create variables in RStudio? (Length: 00:16:27)

```{r, warnings=FALSE, message=FALSE, echo=FALSE}
library(vembedr)
embed_youtube('GlEQFX74bq4', height=400, allowfullscreen = TRUE) %>% use_align('center')
```
[[**Watch on YouTube**]](https://youtu.be/GlEQFX74bq4)
...
## How do we create a variable based on other existing variables within a data frame? (Length: 00:21:00)

```{r, warnings=FALSE, message=FALSE, echo=FALSE}
library(vembedr)
embed_youtube('diHAc50vIhg', height=400, allowfullscreen = TRUE) %>% use_align('center')
```
[[**Watch on YouTube**]](https://youtu.be/diHAc50vIhg)
...
```{r echo=FALSE, out.width = "100%", fig.align='center', cache=TRUE,}
knitr::include_graphics('assets/all_images/basic_building_blocks/02_r_savefile.png', error = FALSE) 
```
