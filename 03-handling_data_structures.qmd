...
SchoolData <- read.csv(file = "Primary Schools in Ealing.csv")
```
...
- `NumberBoys`: Total number of boys in a primary school (**numeric**)
- `NumberGirls`: Total number of girls in a primary school (**numeric**)
- `TotalStudents`: Total number of students in a primary school (**numeric**)
...
## Useful Functions to Examine Data
