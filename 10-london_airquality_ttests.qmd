...
That is how you execute a **t-test**. Now, you should be able to the do final worksheet, and adapt the codes to your own dataset.
...
3. Use the **Unpaired t-test** to perform the statistical test to answer the above question. Provide full interpretation of whether the differences are statistical significant or not.
