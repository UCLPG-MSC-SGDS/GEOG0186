...
From the above information, use the `importAURN()` code to extract all 2025 measure for **PM2.5** and **PM10** from **CA1** and **CLL2** locations. 
...
:::{.callout-important}
**Submission Deadline: Wednesday 3rd December, 2025**
